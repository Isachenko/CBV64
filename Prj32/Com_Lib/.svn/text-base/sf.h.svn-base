...
public:
  ...
  inline bool Lookup(string key, CSFType*& rValue)   { rValue = mtp[key]; return !(rValue==NULL); } 
...
//-------------------- Файл SF_Read.cpp-----------------
  ...
  void InitSFAttrib();
  int ReadSFByName(FILE *fp, long& len,string Name); // Кириенко 21.02.00
